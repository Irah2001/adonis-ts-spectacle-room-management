					...
					<article className="border-sand-7 hover:border-sand-8 group relative row-span-3 flex flex-col gap-8 rounded-2xl border p-6 shadow-sm transition duration-700 ease-in-out hover:shadow">
						<div className="relative opacity-80">
							<svg fill="none" viewBox="0 0 240 105">
								...
								<path fill="url(#b)" fillOpacity=".2" d="M24 85a4 4 0 0 1 4-4h184a4 4 0 0 1 4 4v20H24V85Z" />
								<defs>
					...
					<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
						<article className="hover:border-sand-8 group relative rounded-lg border border-transparent bg-white px-5 py-4 transition duration-100 ease-in-out hover:shadow-sm">
							<h2 className="text-sand-12 font-semibold">
								<a href="https://lucid.adonisjs.com" target="_blank" className="flex flex-row gap-2" rel="noreferrer">
						...
						<article className="hover:border-sand-8 group relative rounded-lg border border-transparent bg-white px-5 py-4 transition duration-100 ease-in-out hover:shadow-sm">
							<h2 className="text-sand-12 font-semibold">
								<a href="https://vinejs.dev/" target="_blank" className="flex flex-row gap-2" rel="noreferrer">
						...
						<article className="hover:border-sand-8 group relative rounded-lg border border-transparent bg-white px-5 py-4 transition duration-100 ease-in-out hover:shadow-sm">
							<h2 className="text-sand-12 font-semibold">
								<a href="https://inertiajs.com/" target="_blank" className="flex flex-row gap-2" rel="noreferrer">
						...
						<article className="hover:border-sand-8 group relative rounded-lg border border-transparent bg-white px-5 py-4 transition duration-100 ease-in-out hover:shadow-sm">
							<h2 className="text-sand-12 font-semibold">
								<a href="https://japa.dev" target="_blank" className="flex flex-row gap-2" rel="noreferrer">
